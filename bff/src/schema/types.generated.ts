...
export type ResolversTypes = {
  ...
  MediaType: ResolverTypeWrapper<'MOVIE' | 'TV'>;
...
export type MediaTypeResolvers = EnumResolverSignature<{ MOVIE?: any, TV?: any }, ResolversTypes['MediaType']>;

export type QueryResolvers<ContextType = any, ParentType extends ResolversParentTypes['Query'] = ResolversParentTypes['Query']> = {
  _empty?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  search?: Resolver<Array<ResolversTypes['Media']>, ParentType, ContextType, RequireFields<QuerysearchArgs, 'query'>>;
};
